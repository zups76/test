...
(function($) {
  ...
  function RemoteServerEventModel() {
    // private
    var PAGESIZE = 20;
    var data = {
      length:0
    ...
    function ensureData(from,to) {
      ...
      '&sortAsc=' + (sortdir>0) +
      '&sortBy=' +sortcol;
      if (VB.monitoring.serverEventsTotal) {
        parms += '&total='+VB.monitoring.serverEventsTotal;
      }

      var url = VB.appCtx+'monitoring/listServerEvents';
  ...
  // RemoteServerEventModel
  $.extend(true, window, {
    VB: {
      monitoring: {
        RemoteServerEventModel: RemoteServerEventModel
      }
    }
  });
})(jQuery);

...
USAGE:
	$(".someclass").progressBarInd();
	$("#progressbar").progressBarInd();
	$("#progressbar").progressBarInd(45);							// percentage
	$("#progressbar").progressBarInd({showText: false });			// percentage with config
	$("#progressbar").progressBarInd(45, {showText: false });		// percentage with config
*/
(function($) {
	$.extend({
		progressBarInd: new function() {
			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					if (argvalue != null && this.bar != null && this.config != null) {
						...
						var $this				= $(this);
						var config				= $.extend({}, $.progressBarInd.defaults, argconfig);
						...
						$bar.css("background-position", '-10px 50%');
						$bar.css("padding", "0");
						$bar.css("margin", "0");
						$this.append($bar);
						$this.append($text);
	...
	$.fn.extend({
        progressBarInd: $.progressBarInd.construct
	});
